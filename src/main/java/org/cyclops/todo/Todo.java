...
@Mod(
        ...
        guiFactory = "org.cyclops.todo.GuiConfigOverview$ExtendedConfigGuiFactory" // TODO: your package name
)
public class Todo extends ModBaseVersionable {
    
    /**
     * The proxy of this mod, depending on 'side' a different proxy will be inside this field.
     * @see net.minecraftforge.fml.common.SidedProxy
     */
    // TODO: your package name (x2), this proxy can be completely removed if not required.
    @SidedProxy(clientSide = "org.cyclops.todo.proxy.ClientProxy", serverSide = "org.cyclops.todo.proxy.CommonProxy")
    ...
    public static void clog(Level level, String message) {
        Todo._instance.getLoggerHelper().log(level, message);
    }
